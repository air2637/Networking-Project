...
public class ModifiedAppClient {
    /*
    public static void main(String args[]) throws Exception {
        // Get the address, port and name of file to send over UDP
        final String hostName = "172.20.10.3";
        final int port = 10344;
        final String fileName = "/Users/weizheng/Desktop/NetworkingPrj/Networking/UDP-file-transfer/123.txt";
